                ...
                <ul class="col-md-9 product-right">
                    <li class="col-xs-12 col-sm-6 col-md-4 product-li">
                        <div class="product-img">
                            <img src="${pageContext.request.contextPath }/img/dalmore-age12-giftset.jpg" alt="사진입니다">
                        </div>
                    ...
                    <li class="col-xs-12 col-sm-6 col-md-4">
                        <div class="product-img">
                            <img src="${pageContext.request.contextPath }/img/majesty-xo.jpg" alt="사진입니다">
                        </div>
                        <div class="product-info">
                    ...
                    <li class="col-xs-12 col-sm-6 col-md-4">
                        <div class="product-img">
                            <img src="${pageContext.request.contextPath }/img/cat.jpg" alt="사진입니다">
                        </div>
                        <div class="product-info">
